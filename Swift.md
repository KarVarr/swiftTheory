...
$${\color{orange}Вынос \space замыкания \space за \space скобки}$$ 
...
$${\color{orange}Различие \space между \space объектом \space и \space классом}$$ 
...
Свойство типа позволяет обратится к свойству класса не создавая объекта в памяти устройства через слово **static**. 
