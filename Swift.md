...
$${\color{orange}Отличия \space классов \space и \space структур}$$ 
* У структуры встроен по умолчанию инициализатор, структура не наследуется, и работает она через стек.
* У классов нет автоматического инициализатора, класс можно наследовать и работает он через кучу(сслыки хранятся в стеке).
...
$${\color{orange}Правила \space выбора \space между \space классом \space и \space структурой}$$ 
